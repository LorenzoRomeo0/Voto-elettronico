...
public class ControllerVotaSchedaCategoricaConPreferenza {
    ...
    @FXML
    void initialize() {
        assert col1 != null : "fx:id=\"col1\" was not injected: check your FXML file 'vota_scheda_categorica_preferenza.fxml'.";
        assert col2 != null : "fx:id=\"col2\" was not injected: check your FXML file 'vota_scheda_categorica_preferenza.fxml'.";
        assert contenitore_scheda != null : "fx:id=\"contenitore_scheda\" was not injected: check your FXML file 'vota_scheda_categorica_preferenza.fxml'.";
        assert dati_scheda != null : "fx:id=\"dati_scheda\" was not injected: check your FXML file 'vota_scheda_categorica_preferenza.fxml'.";
        assert schermata != null : "fx:id=\"schermata\" was not injected: check your FXML file 'vota_scheda_categorica_preferenza.fxml'.";
		...
		session_system = SessionSystem.getInstance();
		scheda = (SchedaCategoricaConPreferenze) session_system.getScheda();
	...
	private void datiGridpane() {
		...
		for (int i = 0; i < liste.size(); i++) {
			try {
				...
				session_system.setMessage(a, i, options);
