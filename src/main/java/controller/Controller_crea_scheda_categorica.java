...
public class Controller_crea_scheda_categorica extends Controller_crea_scheda_o_c_p{
	...
	void inserisci_scheda(ActionEvent event) {
    	...
    	if (titolo.isEmpty()) {
			...
			dao.insert_scheda_categorica(avvio, termine, stato, stato, titolo, values, tipo_scheda);
