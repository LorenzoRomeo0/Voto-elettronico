...
public class Controller_vota_scheda_categorica_preferenza {
	@FXML
	...
	private CheckBoxUpdater options_liste;
	private CheckBoxUpdater options_candidati;
	...
	void initialize() {
		...
		options_liste = new CheckBoxUpdater();
		options_candidati = new CheckBoxUpdater();
		caricaGridpane();
	}
